...
test 123 placeholder, nothing here.
...
- Using the `plugins` DSL
  - Kotlin Script (Application `build.gradle.kts` file)
    ...
    ```kotlin
      // build.gradle.kts
      plugins {
        id("com.thunderhead.android.orchestration-plugin") version "2.0.0-50k8-yellow"
      }
    ```
...
- Using the legacy `buildscript` DSL
  - Kotlin Script
    ...
    buildscript {
        ...
        dependencies {
            classpath("com.thunderhead.android:orchestration-plugin:2.0.0-50k8-yellow")
        }
    }
